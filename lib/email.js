...
export async function sendEmail(options) {
  try {
    ...
    if (!to || !subject || (!html && !text)) {
      throw new Error(
        'Missing required email parameters: to, subject, and content'
      )
    }
...
export const emailTemplates = {
  ...
  bookingConfirmation: (booking) => ({
      ...
      <body>
        ...
        <div class="content">
          ...
          <div class="details">
            ...
            <p><strong>Package:</strong> ${booking.selected_package
              .replace('-', ' ')
          ...
          <div class="details">
            <h3>☕ What's Next?</h3>
            <ul>
              <li>Our team will review your booking within 8 hours</li>
    ...
    text: `
      ...
      Our team will review your booking within 8 hours.
  ...
  adminNotification: (booking) => ({
    ...
    html: `
      ...
      <body>
        ...
        <div class="content">
          ...
          ${
            booking.booking_type === 'group'
              ? `<p><strong>Group Size:</strong> ${booking.number_of_people} people</p>`
              : ''
          }
    ...
    text: `
      ...
      ${
        booking.booking_type === 'group'
          ? `Group Size: ${booking.number_of_people}`
          : ''
      }
          ...
          ${
            ...
            <div style="background: #dcfce7; padding: 20px; border-radius: 8px; margin: 20px 0;">
              ...
              <p>Your booking has been confirmed! We're excited to welcome you on this amazing journey.</p>
                              <p>You'll receive detailed itinerary and preparation instructions within the next 8 hours.</p>
            </div>
          `
              : ''
          }
