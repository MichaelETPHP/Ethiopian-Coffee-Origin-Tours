...
import { ArrowLeft, Coffee, Calendar, MapPin, Users, ChevronDown, ChevronUp, Clock, Star, Utensils, Camera, Plane, ExternalLink } from 'lucide-react';
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://www.thecoffeequest.com/wp-content/uploads/2024/10/Abore.mp4" type="video/mp4" />
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="mb-8 sm:mb-12 animate-fade-in">
            <p className="text-base sm:text-lg lg:text-xl font-inter font-light mb-6 max-w-3xl mx-auto text-cream-100 leading-relaxed">
              Step into the birthplace of Arabica coffee. This immersive journey connects you to the people, places, and processes behind Ethiopia's world-renowned coffees.
            </p>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                ...
                <p className="text-base sm:text-lg font-inter text-coffee-700 leading-relaxed">
                  Whether you're a green buyer, trader, roaster, or passionate enthusiast, this trip offers deep learning, direct trade access, and cultural connection at every stop.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <span className="font-inter font-semibold text-coffee-800">Dates:</span>
                    <span className="font-inter text-coffee-600 ml-2">{tourData.dates}</span>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <MapPin className="h-5 w-5 text-coffee-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-inter font-semibold text-coffee-800">Start/End Point:</span>
                    <span className="font-inter text-coffee-600 ml-2">{tourData.startEnd}</span>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Users className="h-5 w-5 text-coffee-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-inter font-semibold text-coffee-800">Group Size:</span>
                    <span className="font-inter text-coffee-600 ml-2">{tourData.groupSize}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg font-inter text-coffee-600 max-w-3xl mx-auto">
              Explore each day of your Ethiopian coffee journey with detailed activities and experiences.
            </p>
          </div>
                ...
                >
                  <div className="flex items-center space-x-3 sm:space-x-6 flex-1 min-w-0">
                    <div className="bg-coffee-600 text-white w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex flex-col items-center justify-center flex-shrink-0">
                      ...
                      <div className="text-lg sm:text-xl font-playfair font-bold">{day.day}</div>
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-4 text-coffee-600 mb-2">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-xs sm:text-sm font-inter truncate">{day.location}</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <Clock className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
                          <span className="text-xs sm:text-sm font-inter">{day.activities.length} Activities</span>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4 sm:space-y-6 order-2 lg:order-none">
                            ...
                            <ul className="space-y-2">
                              {day.activities.map((activity, actIndex) => (
                                <li key={actIndex} className="flex items-start space-x-3">
                                  ...
                                  <span className="text-coffee-600 font-inter text-xs sm:text-sm leading-relaxed">{activity}</span>
                                </li>
                              ))}
                            </ul>
                          </div>
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs sm:text-sm text-coffee-600 font-inter leading-relaxed">{day.accommodation}</p>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
            {[
              { icon: <Plane className="h-5 w-5 sm:h-6 sm:w-6" />, title: "All Local Travel", desc: "Including flights within Ethiopia" },
              { icon: <Utensils className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Meals & Drinks", desc: "Traditional Ethiopian cuisine and coffee experiences" },
              { icon: <MapPin className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Lodging", desc: "Eco-lodges and guesthouses in coffee regions" },
              { icon: <Camera className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Marketing Support", desc: "Professional content creation to enhance your coffee storytelling" },
              { icon: <Coffee className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Coffee Experiences", desc: "Farm visits, processing tours, and cuppings" },
              { icon: <Users className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Expert Guides", desc: "Local coffee experts and cultural guides" }
            ].map((item, index) => (
              <div key={index} className="text-center p-4 sm:p-6 bg-cream-50 rounded-xl hover:bg-cream-100 transition-colors duration-200">
                <div className="text-coffee-600 mb-3 flex justify-center">
                  {item.icon}
                </div>
                <h4 className="font-playfair font-semibold text-coffee-800 mb-2 text-sm sm:text-base">{item.title}</h4>
                <p className="text-xs sm:text-sm font-inter text-coffee-600 leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base font-inter text-coffee-600 leading-relaxed">
                    Arrivals from Western Europe are typically early morning. Airport transfer will be arranged for all participants.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-inter font-semibold text-coffee-800">Apply here:</span>
                      <a 
                    ...
                    <div className="text-sm font-inter text-coffee-600">
                      <p><strong>Fee:</strong> $62</p>
                      <p><strong>Processing time:</strong> 3 business days</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 p-6 bg-coffee-100 rounded-xl">
            <p className="text-sm sm:text-base font-inter text-coffee-700 text-center leading-relaxed">
              <strong>Important:</strong> Please ensure your passport is valid for at least 6 months from your travel date. 
              We recommend applying for your e-visa at least 2 weeks before departure to allow for any processing delays.
            </p>
          </div>
        </div>
      </section>
