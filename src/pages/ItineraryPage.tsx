...
import { ArrowLeft, Coffee, Calendar, MapPin, Users, ChevronDown, ChevronUp, Clock, Star, Utensils, Camera, Plane } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <Coffee className="h-5 w-5 text-coffee-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-inter font-semibold text-coffee-800">Organizer:</span>
                    <span className="font-inter text-coffee-600 ml-2">{tourData.organizer}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              { icon: <Utensils className="h-5 w-5 sm:h-6 sm:w-6" />, title: "All Meals", desc: "Traditional Ethiopian cuisine and coffee experiences" },
              { icon: <MapPin className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Accommodation", desc: "Eco-lodges and guesthouses in coffee regions" },
              { icon: <Plane className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Transportation", desc: "All domestic flights and ground transport" },
              ...
              { icon: <Camera className="h-5 w-5 sm:h-6 sm:w-6" />, title: "Documentation", desc: "Professional photos and sourcing certificates" }
            ].map((item, index) => (
