...
export const tourPackages: Record<string, TourPackage> = {
  'southern-ethiopia': {
    ...
    price: '$1,850 USD',
    includes: 'All meals, accommodation, transport, processing experiences, cupping sessions',
  ...
  'western-ethiopia': {
    ...
    price: '$1,650 USD',
    includes: 'All meals, accommodation, transport, forest tours, cultural experiences',
  ...
  'complete-ethiopia': {
    ...
    price: '$2,850 USD',
    includes: 'All meals, accommodation, transport, comprehensive experiences, cultural activities',
