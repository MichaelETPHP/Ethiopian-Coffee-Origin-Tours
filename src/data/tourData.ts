...
export const tourPackages: Record<string, TourPackage> = {
  'southern-ethiopia': {
    ...
    price: '$1,850 USD',
    includes:
      'All meals, accommodation, transport, processing experiences, cupping sessions',
    notinclude: 'Flights, visas, and personal expenses',
    description:
    ...
    overview:
      "From heirloom varieties grown in misty highlands to cooperative-led traceability systems and forest-grown naturals, you'll gain firsthand insight into what makes Ethiopian coffee legendary. Whether you're a roaster, café owner, importer, green buyer, or passionate coffee explorer, this trip offers exclusive access to top producers, cuppings at origin, and relationship-driven sourcing opportunities.",
    itinerary: [
      {
        day: 1,
        date: 'November 26',
      ...
      },
      {
        ...
        description:
          "Dive deep into Sidama's coffee culture with hands-on farm experiences, processing demonstrations, and cupping sessions that showcase the region's distinctive flavor profiles.",
        activities: [
        ...
        image:
          'https://images.pexels.com/photos/4349775/pexels-photo-4349775.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
        highlights: [
          'Coffee picking',
          'Processing methods',
          'Cultural ceremony',
      ...
      },
      {
        ...
        description:
          "Travel to the legendary Yirgacheffe region, famous for producing some of the world's most distinctive and floral coffee profiles. Experience the unique terroir that makes Yirgacheffe coffee so special.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Spend a full day exploring Yirgacheffe's renowned cooperatives and processing facilities. Learn about the meticulous care that goes into producing these world-famous coffees.",
        activities: [
        ...
        image:
          'https://images.pexels.com/photos/1251175/pexels-photo-1251175.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      ...
      },
      {
        ...
        location: 'Guji Zone',
        description:
          'Journey to the Guji region, known for its fruity, wine-like coffee characteristics. Meet innovative producers who are pushing the boundaries of Ethiopian coffee processing.',
        activities: [
        ...
        image:
          'https://images.pexels.com/photos/1002703/pexels-photo-1002703.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
        highlights: [
          'Guji terroir',
      ...
      },
      {
        ...
        description:
          'Explore cutting-edge processing methods in Guji, including anaerobic fermentation and extended drying techniques that create unique flavor profiles.',
        activities: [
      ...
      },
      {
        ...
        description:
          'Return to Addis Ababa for final cuppings, reflection on your journey, and opportunities to finalize any direct trade relationships established during the trip.',
        activities: [
  ...
  'western-ethiopia': {
    ...
    price: '$1,650 USD',
    includes:
      'All meals, accommodation, transport, forest tours, cultural experiences',
    notinclude: 'Flights, visas, and personal expenses',
    description:
    ...
    overview:
      "Discover where coffee began in the wild forests of Kaffa, explore traditional processing in Jimma, and witness large-scale sustainable production at Bebeka Estate. This adventure takes you off the beaten path to coffee's most authentic origins.",
    itinerary: [
      {
        day: 1,
        date: 'December 1',
        ...
        description:
          "Begin your western Ethiopia adventure with a journey to Jimma, one of Ethiopia's most important historical coffee centers. Discover traditional farming methods and the deep cultural significance of coffee.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Explore Jimma's rich coffee heritage with visits to traditional processing sites and meetings with multi-generational coffee families who have preserved ancient techniques.",
        activities: [
      ...
      },
      {
        ...
        description:
          'Travel to the legendary Kaffa region, widely regarded as the birthplace of Arabica coffee. Discover wild coffee forests and learn about the origin story of coffee discovery.',
        activities: [
      ...
      },
      {
        ...
        description:
          "Spend a full day immersed in Kaffa's wild coffee forests, where Arabica coffee grows naturally. Experience the pristine environment where coffee first evolved.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Visit Ethiopia's largest and oldest coffee estate at Bebeka. Experience large-scale coffee production while maintaining traditional Ethiopian coffee values and sustainable practices.",
        activities: [
      ...
      },
      {
        ...
        location: 'Addis Ababa',
        description:
          "Return to Addis Ababa for final reflections on your western Ethiopia coffee journey and opportunities to explore the capital's vibrant coffee scene.",
        activities: [
          'Return journey to Addis Ababa',
  ...
  'complete-ethiopia': {
    ...
    price: '$2,850 USD',
    includes:
      'All meals, accommodation, transport, comprehensive experiences, cultural activities',
    notinclude: 'Flights, visas, and personal expenses',
    description:
    ...
    overview:
      'This comprehensive journey covers every major coffee region in Ethiopia, from the floral highlands of Yirgacheffe to the wild forests of Kaffa. Experience the complete story of Ethiopian coffee, from its ancient origins to modern innovations, with exclusive access to top producers and processing facilities.',
    itinerary: [
      {
        day: 1,
        date: 'November 26',
        ...
        location: 'Addis Ababa',
        description:
          'Welcome to Ethiopia! Begin your comprehensive coffee journey with an orientation to Ethiopian coffee culture and history in the capital city.',
        activities: [
      ...
      },
      {
        ...
        location: 'Sidama Region',
        description:
          "Journey to Sidama, one of Ethiopia's most renowned coffee regions, and begin your immersion into cooperative-based coffee production.",
        activities: [
      ...
      },
      {
        ...
        location: 'Yirgacheffe Region',
        description:
          "Travel to the legendary Yirgacheffe region and experience the unique terroir that produces the world's most distinctive coffee flavors.",
        activities: [
      ...
      },
      {
        ...
        location: 'Yirgacheffe Cooperatives',
        description:
          "Spend a full day exploring Yirgacheffe's processing facilities and learning about the meticulous care behind these world-famous coffees.",
        activities: [
      ...
      },
      {
        ...
        location: 'Guji Zone',
        description:
          'Explore the innovative Guji region, known for experimental processing and distinctive fruity, wine-like coffee characteristics.',
        activities: [
      ...
      },
      {
        ...
        location: 'Jimma Region',
        description:
          'Transition from southern to western Ethiopia, arriving in Jimma to explore traditional coffee heritage and historical significance.',
        activities: [
      ...
      },
      {
        ...
        location: 'Jimma Highlands',
        description:
          "Deep dive into Jimma's coffee heritage with traditional processing experiences and multi-generational family meetings.",
        activities: [
      ...
      },
      {
        ...
        location: 'Kaffa Region',
        description:
          "Journey to Kaffa, the legendary birthplace of coffee, to explore wild coffee forests and learn about coffee's origin story.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Full immersion in Kaffa's pristine wild coffee forests where Arabica coffee grows in its natural habitat.",
        activities: [
      ...
      },
      {
        ...
        description:
          "Visit Ethiopia's largest coffee estate to understand large-scale sustainable production and modern quality systems.",
        activities: [
      ...
      },
      {
        ...
        location: 'Addis Ababa',
        description:
          'Return to Addis Ababa for final celebrations, comprehensive cupping, and reflection on your complete Ethiopian coffee journey.',
        activities: [
          'Return journey to Addis Ababa',
