      ...
      >
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center py-3 sm:py-4'>
            ...
            >
              <span
                className={`flex items-center gap-3 text-base sm:text-lg lg:text-xl font-playfair font-bold ${
          ...
          <div className='flex flex-col h-full'>
            ...
            <div className='flex items-center justify-between p-4 border-b border-coffee-200 bg-white'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-lg font-playfair font-bold text-coffee-600'>
                  Ethiopian Coffee
                </span>
              </div>
              <button
