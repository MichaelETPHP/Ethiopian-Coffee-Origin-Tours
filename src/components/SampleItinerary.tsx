      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center space-x-2 bg-coffee-100 px-3 sm:px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-xs sm:text-sm font-inter font-medium text-coffee-600">2025 Origin Trip</span>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
            {[
              { icon: <Calendar className="h-4 w-4 sm:h-5 sm:w-5" />, label: "Duration", value: tourData.duration },
              { icon: <Users className="h-4 w-4 sm:h-5 sm:w-5" />, label: "Group Size", value: tourData.groupSize },
              { icon: <MapPin className="h-4 w-4 sm:h-5 sm:w-5" />, label: "Regions", value: `${tourData.regions.length} Major` },
              { icon: <Star className="h-4 w-4 sm:h-5 sm:w-5" />, label: "Price", value: tourData.price }
            ].map((item, index) => (
              <div key={index} className="bg-white p-3 sm:p-4 rounded-xl shadow-sm border border-cream-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-cream-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                <Users className="h-4 w-4 text-coffee-500 flex-shrink-0 mt-0.5" />
                <span className="text-xs sm:text-sm font-inter text-coffee-600">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-cream-200">
            ...
            <div className="mt-6 p-4 bg-cream-50 rounded-xl">
              <h4 className="font-playfair font-semibold text-coffee-800 mb-2 text-sm sm:text-base">What's Included</h4>
              <p className="text-xs sm:text-sm text-coffee-600 font-inter">{tourData.includes}</p>
            </div>
          </div>
        </div>
        ...
        <div className="sticky top-16 sm:top-20 z-40 bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-6 sm:mb-8 shadow-lg border border-cream-200">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <h4 className="font-playfair font-semibold text-coffee-800 text-sm sm:text-base">Quick Navigation</h4>
        ...
        <div className="mt-12 sm:mt-16 bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-sm border border-cream-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              { icon: <Utensils className="h-4 w-4 sm:h-5 sm:w-5" />, title: "All Meals", desc: "Traditional Ethiopian cuisine and coffee experiences" },
              { icon: <MapPin className="h-4 w-4 sm:h-5 sm:w-5" />, title: "Accommodation", desc: "Eco-lodges and guesthouses in coffee regions" },
              { icon: <Plane className="h-4 w-4 sm:h-5 sm:w-5" />, title: "Transportation", desc: "All domestic flights and ground transport" },
              { icon: <Coffee className="h-4 w-4 sm:h-5 sm:w-5" />, title: "Coffee Experiences", desc: "Farm visits, processing tours, and cuppings" },
              { icon: <Users className="h-4 w-4 sm:h-5 sm:w-5" />, title: "Expert Guides", desc: "Local coffee experts and cultural guides" },
              { icon: <Camera className="h-4 w-4 sm:h-5 sm:w-5" />, title: "Documentation", desc: "Professional photos and sourcing certificates" }
            ].map((item, index) => (
